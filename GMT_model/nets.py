...
class GraphMultisetTransformer(GraphRepresentation):
    ...
    def __init__(self, num_features, num_hidden, num_classes, num_heads,avg_num_nodes,medium=False):
    ...
    def get_pools(self, _input_dim=None, reconstruction=False):
        ...
        _input_dim = self.nhid * 2 if _input_dim is None else _input_dim
        _output_dim = self.nhid
